    ...
    <>
        <div>
            ...
            <ul className='flex mobile:flex-wrap  mt-[16px]'>
                <li className='tablet:w-[calc(33.3333%-18px)] mobile:w-[calc(50%-6.6666px)]  h-[61px] border border-[#CECECE] rounded-[8px] flex  justify-center items-center text-[#7B7B7B] cursor-pointer tablet:mr-[27px] mobile:mr-[10px]  mobile:mb-[10px]'>
                ...
                <li className='tablet:w-[calc(33.3333%-18px)] mobile:w-[calc(50%-6.6666px)] h-[61px] border border-[#CECECE] rounded-[8px] flex  justify-center items-center text-[#7B7B7B] cursor-pointer tablet:mr-[27px] mobile:mr-0'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <li className='tablet:w-[calc(33.3333%-18px)] mobile:w-[calc(50%-6.6666px)] h-[61px] border border-[#CECECE] rounded-[8px] flex  justify-center items-center text-[#7B7B7B] cursor-pointer'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
