        ...
        <div className='w-[240px] h-[calc(100vh-80px)] px-[24px] py-[65px] bg-[#162850] text-white rounded-tr-[30px] sticky top-[80px]'>
            ...
            <div className='mt-[30px]'>
                <ul>
                    ...
                    <li className=''>
                        <Link to='/number' className={`flex cursor-pointer text-white transition items-center w-[192px] h-[52px] p-[10px]  mb-[17px] rounded-[8px] ${isChecked === 'number' ? 'bg-button_color' : ''}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <li className=''>
                        <Link to='/address' className={`flex cursor-pointer text-white transition items-center w-[192px] h-[52px] p-[10px]  mb-[17px] rounded-[8px] ${isChecked === 'address' ? 'bg-button_color' : ''}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
