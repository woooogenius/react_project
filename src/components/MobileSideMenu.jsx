        ...
        <div className='mt-[30px]'>
            <ul>
                ...
                <li className=''>
                        ...
                        <label onClick={()=>handleClick('send')} className={`flex cursor-pointer items-center transition w-[45px] h-[45px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'send' ? 'bg-button_color' : ''}`}>
                ...
                <li className=''>
                        ...
                        <label  onClick={()=>handleClick('result')} className={`flex cursor-pointer transition items-center w-[192px] h-[52px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'result' ? 'bg-button_color' : ''}`}>
                ...
                <li className=''>
                        <label className={`flex cursor-pointer transition items-center w-[192px] h-[52px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'credit' ? 'bg-button_color' : ''}`}>
                ...
                <li className=''>
                        <label className={`flex cursor-pointer transition items-center w-[192px] h-[52px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'template' ? 'bg-button_color' : ''}`}>
                ...
                <li className=''>
                        <label className={`flex cursor-pointer transition items-center w-[192px] h-[52px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'number' ? 'bg-button_color' : ''}`}>
                ...
                <li className=''>
                        <label className={`flex cursor-pointer transition items-center w-[192px] h-[52px] p-[10px]  mb-[30px] rounded-[8px] ${isChecked === 'address' ? 'bg-button_color' : ''}`}>
